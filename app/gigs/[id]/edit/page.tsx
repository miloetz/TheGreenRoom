...
export default function EditGig() {
  ...
  useEffect(() => {
    if (gig) {
      setFormData({
        ...
        pay_min: gig.pay_min?.toString() || '',
        pay_max: gig.pay_max?.toString() || '',
        genres: gig.genres || [],
  ...
  const isLoading = userLoading || gigLoading

  // Redirect if not the owner
  if (!isLoading && gig && profile && gig.venue_id !== profile.id) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="heading-lg mb-2">gig not found</h1>
    ...
    <div className="min-h-screen py-8">
      <div className="max-w-2xl mx-auto px-6">
        ...
        <div className="card-flat p-6 md:p-8 animate-fade-in-up">
          <h1 className="heading-lg mb-2">edit gig</h1>
          <p className="text-[var(--muted)] mb-8">update the details for your gig</p>

          {updateGigMutation.isError && (
            <div className="mb-6 alert-error animate-fade-in">
              {updateGigMutation.error?.message || 'failed to update gig'}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-3 pt-4">
              ...
              <button
                type="submit"
                disabled={updateGigMutation.isPending || formData.genres.length === 0}
